...
class List {
 public:
  typedef char Item; // The type of items you can store in a List
 ...
 // I am not going to describe each method since they are quite standard
  ...
  // This method checks to see if the list is equal to the passed list.
  bool equalTo(Node* actual, Node* other) const;
